            ...
            rawObjectDefinitions{
                {{SettlementObjectTypes::Graveyard,"Graveyard",SettlementObjectCategory::Wellness,1,
                 ...
                 {SettlementObjectTypes::FishingGrounds,
                  ...
                  initialConstructionResourceCosts, false},
                 ...
                 {SettlementObjectTypes::TradeDepot,
                  ...
                  false,
                  SettlementObjectPlacementLayer::Structure,
                  {{136, 96, 68}, {235, 196, 107}, 4, 4},
                  initialConstructionResourceCosts,
                  false},
                 {SettlementObjectTypes::CoalMine,
                  "Coal Mine",
                  SettlementObjectCategory::Production,
                  0,
                  SettlementFootprintSelectionMode::DragRectangle,
                  1,
                  1,
                 ...
                 enclosed(
                     {SettlementObjectTypes::Barracks,
                      "Barracks",
                      SettlementObjectCategory::Warfare,
                      1,
                      SettlementFootprintSelectionMode::DragRectangle,
                      3,
                      3,
