...
namespace Paladin
{
    ...
    public:
        ...
        // Player depot lifecycle lives in WorldMarketOrders.cpp, separate
        // from price formation, offer selection and the AI market census.
        static bool setOrder(World&, RealmId, SettlementId, SettlementObjectId,
                             std::string_view, TradeDirection, int, bool);
        static bool placeOrder(World&, RealmId, SettlementId, SettlementObjectId,
                               std::string_view, TradeDirection, int, bool);
        static bool cancelOrder(World&, RealmId, SettlementId,
                                SettlementObjectId, std::uint64_t);
        static void tickOrders(World&, double minute);
