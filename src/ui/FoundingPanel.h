...
namespace Paladin
{
    ...
    private:
        ...
        [[nodiscard]] bool canContinueFromRealm() const noexcept;
        void showRealmStep();
        ...
        static constexpr std::size_t originCount = startingRealmOrigins.size();
        static constexpr std::size_t flagCellCount =
            RealmFlag::defaultWidth * RealmFlag::defaultHeight;

        UiTextField realmNameField_;
        ...
        FoundingPanelStep step_ = FoundingPanelStep::Realm;
