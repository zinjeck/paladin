...
namespace Paladin
{
    WorldHud::WorldHud()
        : selectRegionButton_("Select Region"),
          ...
          editRealmButton_("Edit Realm"), playButton_("Play"),
          backButton_("Back")
    {
    ...
    void WorldHud::pointerMoved(float x, float y) noexcept
    {
        ...
        if (!simulationControlsUnlocked_)
        {
            ...
            editRealmButton_.pointerMoved(x, y);
        }
    ...
    bool WorldHud::pointerPressed(float x, float y) noexcept
    {
        ...
        if (capitalEstablished_ && !simulationControlsUnlocked_)
        {
            actionCaptured = moveCapitalButton_.pointerPressed(x, y) ||
                             ...
                             editRealmButton_.pointerPressed(x, y);
        }
    ...
    {
        return backButton_.containsPoint(x, y) ||
               ...
               (capitalEstablished_ && !simulationControlsUnlocked_ &&
                (moveCapitalButton_.containsPoint(x, y) ||
                 ...
                 editRealmButton_.containsPoint(x, y)));
    }
    ...
    WorldHudAction WorldHud::pointerReleased(float x, float y) noexcept
    {
        ...
        const bool editClicked = editRealmButton_.pointerReleased(x, y);
        ...
        {
            return WorldHudAction::EditRealm;
        }
    ...
    )
    {
        ...
        else if (!simulationControlsUnlocked_)
        {
            ...
            editRealmButton_.render(renderer, uiRenderer);
        }
